...
namespace LMSystem.Repository.Migrations
{
    ...
    [Migration("20251122204946_AddApproveCourse_v3")]
    partial class AddApproveCourse_v3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMSystem.Repository.Models.Field", b =>
                {
            ...
            modelBuilder.Entity("LMSystem.Repository.Models.FieldCategory", b =>
                {
                    b.Property<int>("FieldCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("FieldCategoryId"));
                    ...
                    b.HasKey("FieldCategoryId");

                    b.HasIndex("CategoryId");

                    b.HasIndex("FieldId");

                    b.ToTable("FieldCategory", (string)null);
                });
            ...
            modelBuilder.Entity("LMSystem.Repository.Models.FieldCategory", b =>
                {
                    ...
                    b.HasOne("LMSystem.Repository.Models.Field", "Field")
                        .WithMany("FieldCategories")
