            ...
            <div className="text-[#333]">
              ...
              <div className="mt-8 flex flex-col gap-8 bg-[#f7f9fa] px-4 py-2">
                <div className="flex items-center">
                  <p className="text-base font-medium text-[#1677ff]">Tiêu đề khóa học:</p>
                ...
                <div className="mt-8 flex flex-col gap-2 bg-[#f7f9fa] px-4 py-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tagsData.length === 0 && (
                      <span className="text-gray-500 italic">Chưa có thể loại nào.</span>
                    )}
