...
function RegisterPage() {
  ...
  <p className="text-gray-600 mb-3 text-base font-medium">Bạn là giáo viên?</p>
  <Link to="/register/teacher">
    <Button
      type="default"
      className="bg-greenHome text-white font-semibold px-8 h-12 rounded-lg"
    >
      Đăng ký dành cho giáo viên
    </Button>
  </Link>
</div>
